...
export default function Navbar() {
  ...
  return (
    <nav className={"navbar navbar-expand-lg sticky-top shadow p-2 bg-white rounded " + styles.navbarMainSection} >
      ...
      <a className={"navbar-brand  " + styles.textColorLogo} style={{ "marginLeft": "10px" }} href="/"><img src={LogoImg} className='mb-1' alt='homeimage' height='20px' />&nbsp;Cloud-FMS</a>
      ...
      <div className="collapse navbar-collapse" id="navbarNav">
        <ul className="navbar-nav">
          <li className="nav-item active">
            <a className={"nav-link " + styles.textColor} href="/dashboard">Dashboard</a>
          </li>
